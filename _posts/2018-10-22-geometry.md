...
If you’ve read this far and you’re not convinced of the tetradecahedron’s power, let’s turn to design and Space (with a big s). Technologically speaking, aeronautics could use the geometrical properties of the tetradecahedron.  
Now imagine it is the shape of a space module (i.e. a standardized part or independent unit), we can construct a more complex structure. Provided the functionality of such modules is solved for living quarters, clustering them and shaping cities on other planets is a logical step.
\s
