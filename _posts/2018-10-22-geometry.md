...
An important example dates back from ca. 2000 BC in Prehistoric Scotland, where carved [stone](https://en.wikipedia.org/wiki/Carved_stone_balls) balls exhibit a variety of symmetries including all of the symmetries of Platonic solids (link to section).
...
![](/images/platonic.png){: .center-image } <div style="display: inline-block;"> Polyhedral graphs corresponding to the skeleton of Platonic solids. The five platonic graphs are represented from top to bottom:  tetrahedral, cubical, octahedral, dodecahedral, and icosahedral. 
</div>
