...
* **Awotoro, E. O.**, **Ezekannagha, C.**, Schwarz, F., Tauscher, J., Heider, D., Ladewig, K., Moncoq, K., Miroux, B., **Hattab, G.** (2024). Bridging the Gap in Membrane Protein Research through Machine Learning, Visualization and Metadata Enrichment of Membrane Protein Structures, *Nature Communications Biology*, (in preparation).
...
* Wehrli, S., **Ezekannagha, C.**, **Hattab, G.**, Boender, T. S., Arnrich, B., Irrgang, C. (2024). Guiding Sentiment Analysis with Hierarchical Text Clustering: Analyzing the German X/Twitter Discourse on Face Masks in the 2020 COVID-19 Pandemic, *ACL Workshop on Computational Approaches to Subjectivity, Sentiment & Social Media Analysis (WASSA)*, (accepted).
